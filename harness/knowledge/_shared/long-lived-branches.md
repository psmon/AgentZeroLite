...
_등재: 2026-08-21 (PR #12 리뷰 세션). 갱신: 2026-09-19 — `feat/avalonia-v2` M0033~M0040 완료 후 운영자 "잘 작동" 확인, main에 fast-forward 병합(WPF 무변경 확인). 브랜치는 2차 작업 기점으로 남김. 2026-09-18 — `feat/avalonia-crossplatform` 폐기(운영자 승인), `feat/avalonia-v2` 등재; 정리 후보였던 `fix/voice-note-loopback-crash`는 삭제 완료._
