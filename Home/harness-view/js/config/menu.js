/**
 * 메뉴 정의 — 각 항목은 hash route (#id) 와 연결됨
 * 각 항목은 dynamic import 대상 뷰 모듈로 매핑됨 (js/views/*.js)
 */
export const MENU = [
...
/**
 * 간단한 inline SVG 아이콘 맵 (외부 아이콘 라이브러리 없이 가볍게)
 * lucide 스타일을 단순화한 stroke 아이콘
 */
export const ICONS = {
  ...
  tag:      '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41 13.42 20.58a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>',
